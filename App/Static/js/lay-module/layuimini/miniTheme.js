        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="#" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 官方网站</a>\n' +
                    '<a class="more-menu-item" href="#" target="_blank"><i class="layui-icon layui-icon-theme"></i> 联系我们</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
